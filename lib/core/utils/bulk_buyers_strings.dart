class BCStrings {
  ...
  static const appName = 'Bulk Buyers Connect';
  static const emptyStr = ' can be null but it should not be empty';
  static const passMismatch = 'Please confirm that your passwords are the same';
  ...
  static const String privacy =
      'Bulk Buyers Connect promises to keep your personal information private';
}
